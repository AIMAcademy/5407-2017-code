...
public class RobotBase {
	...
	public void omniDrive(double forwardSpeed, double sidewaysSpeed, double rotate){
		...
		this.mot_SidewaysMotor1.set(sidewaysSpeed*sidewaysSpeed*sidewaysSpeed + rotate * 0.5 * 1.145);
		this.mot_SidewaysMotor2.set((sidewaysSpeed*sidewaysSpeed*sidewaysSpeed* -1) + rotate * 0.5 * 1.145);  
	}
	...
	// values are cubed but the sideways speed is halved
	public void slowDriveStraight(double forwardSpeed, double sidewaysSpeed, double followAngle, double presentAngle){
		this.driveStraight(forwardSpeed, sidewaysSpeed /1.2599, followAngle, presentAngle);
	}
